...
func (c *EquipmentPerformance5SCController) ReadExcel() {
...
func (c *EquipmentPerformance5SCController) ReadData(sheetName string) error {
	...
	config := clit.Config("equipmentPerformance", "5SC", nil).(map[string]interface{})
...
func (c *EquipmentPerformance5SCController) selectItemID(param SqlQueryParam) error {
